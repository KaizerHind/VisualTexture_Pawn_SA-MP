Public Class PSWiki
    ...
    Private Sub PSWiki_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Panel2.Hide()
        ListBox1.Visible = 1
        ListBox1.Enabled = 1
        RichTextBox4.Hide()
    ...
    Private Sub ListBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ListBox1.SelectedIndexChanged
        Select Case ListBox1.SelectedIndex
            ...
            Case 2
                ...
                Inform.Text = ""
                FRTag.Text = "playerid, dialogid, response, listitem,
inputtext[]"
...
ShowPlayerDialog(playerid, DIALOG_PW, DIALOG_STYLE_MSGBOX, <span class=""hljs-string"">""Duda""</span>, <span class=""hljs-string"">""Te gusta PSWiki?""</span>, <span class=""hljs-string"">""Si""</span>, <span class=""hljs-string"">""No""</span>);
...
<pre class=""hljs""><code><span class=""hljs-function""><span class=""hljs-keyword"">public</span> <span class=""hljs-title"">OnGameModeInit</span><span class=""hljs-params"">()</span>
    ...
    <span class=""hljs-keyword"">return</span> <span class=""hljs-number"">1</span>;
            ...
            Case 5
                ...
                Inform.Text = ""
                FRTag.Text = "playerid, Float:fX, Float:fY, Float:fZ"
...
<pre class=""hljs""><code><span class=""hljs-function""><span class=""hljs-keyword"">public</span> <span class=""hljs-title"">OnPlayerClickMap</span><span class=""hljs-params"">(playerid, Float:fX, Float:fY, Float:fZ)</span>
    ...
    <span class=""hljs-keyword"">return</span> <span class=""hljs-number"">1</span>;
            ...
            Case 6
                ...
                Inform.Text = ""
                FRTag.Text = "playerid, clickedplayerid, source."
...
<pre class=""hljs""><code><span class=""hljs-function""><span class=""hljs-keyword"">public</span> <span class=""hljs-title"">OnPlayerConnect</span><span class=""hljs-params"">(playerid)</span>
    ...
    <span class=""hljs-keyword"">return</span> <span class=""hljs-number"">1</span>;
            ...
            Case 8
                ...
                Inform.Text = ""
                FRTag.Text = "playerid, killerid, reason"
...
jugador entra a un vehiculo."
                FRTag.Text = "playerid, vehicleid, ispassenger"
...
en Descripcion."
                FRTag.Text = "playerid, newkeys, oldkeys"
...
<Body>
    ...
    Private Sub PSWiki_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseDown
    ...
    Private Sub PSWiki_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseMove
        If MoveForm Then
            Me.Location = New Point((Me.Left + e.X - CordX), (Me.Top + e.Y - CordY))
        End If
    End Sub

    Private Sub PSWiki_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseUp
        MoveForm = 0
